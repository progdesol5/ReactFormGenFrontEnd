...
import { UserFunPage, UserMstContent } from '@/pages/dashboards - Copy';
    ...
    <Routes>
      <Route element={<RequireAuth />}>
        ...
        <Route element={getDemoLayout()}>
          ...
          <Route path="dark-sidebar" element={<Demo1DarkSidebarPage />} />
          <Route path="/tables" element={<Tables />} />
          <Route path="/User/user-master" element={<UserMstContent />} />
          <Route path="/User/user-function" element={<UserFunPage />} />
          <Route path="/table" element={<TablePage />} />
          {/* <Route path="/generated-table" element={<GenerateForm />} /> */}
